        ...
        <div class="p-5 space-y-4">
          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-3">
              <button
                :disabled="creating"
                class="flex flex-col gap-2 border-2 border-gray-200 rounded-xl p-4 hover:border-blue-400 hover:bg-blue-50 transition-colors text-left disabled:opacity-50"
                @click="createBlank"
              >
                <div class="text-sm font-medium text-gray-800">Start blank</div>
                <div class="text-xs text-gray-400">Add columns manually in the editor</div>
              </button>
              <button
                :disabled="creating"
                class="flex flex-col gap-2 border-2 border-gray-200 rounded-xl p-4 hover:border-purple-400 hover:bg-purple-50 transition-colors text-left disabled:opacity-50"
                @click="createWithAI"
              >
                <div class="text-sm font-medium text-gray-800">Build with AI</div>
                <div class="text-xs text-gray-400">Describe your KPIs and let AI draft the columns</div>
              </button>
            </div>
          </div>
        </div>
